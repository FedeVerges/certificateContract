...
const HDWalletProvider = require("@truffle/hdwallet-provider");
const mnemonic = 'trip control nose else boring sad devote bring dumb machine certain husband'
module.exports = {
  /**
  ...
  networks: {
    ...
    // ropsten: {
    //   provider: () => new HDWalletProvider(mnemonic, `https://ropsten.infura.io/v3/04be9cd572fa4376a643b4b78aaa7498`),
